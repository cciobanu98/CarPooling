...
namespace CarPooling.Context.Migrations
{
    ...
    [Migration("20190328114007_Initial")]
            ...
            modelBuilder.Entity("CarPooling.Domain.Ride", b =>
                {
                    ...
                    b.HasOne("CarPooling.Domain.City", "DestinationCity")
                        .WithOne("RideDestination")
                        .HasForeignKey("CarPooling.Domain.Ride", "DestinationCityId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CarPooling.Domain.City", "SourceCity")
                        .WithOne("RideSorce")
                        .HasForeignKey("CarPooling.Domain.Ride", "SourceCityId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
